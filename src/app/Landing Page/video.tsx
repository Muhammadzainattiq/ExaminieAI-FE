...
const VideoDemoSection: FC = () => {
  return (
    <section className="relative bg-green-900 text-white py-10 flex flex-col items-center overflow-hidden"> {/* Reduced padding */}
      {/* Heading */}
      <h2 className="text-3xl md:text-4xl font-bold mb-4">
        Discover How Our Solution Works
      </h2>
      <p className="text-center text-green-200 mb-6"> {/* Reduced margin */}
